    ...
    <div className="min-h-screen font-body text-slate-900 bg-[#F5F5F7] overflow-x-hidden selection:bg-[#fe5454] selection:text-white relative">
      ...
      <main className="relative z-10 flex flex-col items-center justify-start min-h-screen px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        ...
        <Infobox title="Wichtiger Hinweis vorab:" variant="amber">
          ...
          in der Anpassung an deine spezifische Zielgruppe, deine Persönlichkeit
          und dein Angebot. Kopiere nichts blind, sondern adaptiere es. Wichtig
          ist, dass du anfängst und Daten sammelst.
        </Infobox>
        ...
        <div className="glass-card rounded-[2rem] p-8 sm:p-12 space-y-6">
          ...
          <div className="prose prose-lg text-slate-700 max-w-none">
            ...
            <p>
              ...
              (Leading KPIs: Nachrichten senden) → mehr gebuchte Calls (Lagging
              KPIs: Umsatz).
            </p>
            ...
            <div className="bg-white/50 p-6 rounded-xl border border-slate-200/60 mt-6 backdrop-blur-sm">
              ...
              <p>
                ...
                niemand deine Zielkunden so gut kennt wie du. Die Strategie muss
                am Ende des Tages zu dir passen.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="glass-panel rounded-[2rem] p-8 sm:p-12 space-y-8">
          ...
          <div className="bg-slate-50/50 rounded-xl p-6 border border-slate-200">
            ...
            <p className="text-slate-700 mb-4">
              In einem Gespräch schnell zu reagieren und die Persönlichkeit des
              Gegenüber zu erkennen und Fingerspitzengefühl zu haben, basiert
              auf Intuition. Viele, die mit Outreach beginnen, haben diese
              Intuition noch nicht. Das folgende Protokoll kannst du also erst
              einmal nutzen, um es dann mit der Zeit für dich anzupassen.
            </p>
            <p className="text-slate-700">
              ...
              ich Rückschlüsse erst, wenn ich mindestens 100 Leute angeschrieben
              habe. Mehr ist immer besser, doch am Ende soll es ja praktikabel
              bleiben.
            </p>
          </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="glass-card p-6 rounded-xl">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  Baseline (2% Reply Rate). Egal wie schlecht die Zahl ist – sie
                  ist unser Startpunkt. Ohne Baseline fliegst du blind.
                </p>
              </div>
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                <p className="text-slate-600 text-sm">
                  Der größte Fehler im Outreach: Man ändert alles gleichzeitig.
                  <br />
                  <br />
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  <br />
                  <br />
                  <strong>Sample Size:</strong> Wir treffen keine Entscheidungen
                  unter 50–100 Datenpunkten (gesendeten Anfragen).
                </p>
              </div>
              ...
              <div className="glass-card p-6 rounded-xl">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  Ein &quot;Nein&quot; ist keine persönliche Ablehnung, sondern
                  nur ein Datenpunkt.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-12">
          <div className="text-center">
            ...
            <Infobox variant="slate">
              ...
              es mit der Zeit für sich, damit es für sie, ihre Persönlichkeit
              und ihr Produkt passt. Es gibt nicht den einen Weg!
            </Infobox>
          </div>
          ...
          <div className="glass-panel rounded-[2rem] p-8 sm:p-12 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-4">
              <div className="bg-[#00D4AA]/10 p-6 rounded-xl border border-[#00D4AA]/20">
                ...
                <ul className="space-y-2 text-slate-700">
                  <li className="flex gap-2">
                    <span className="text-[#00D4AA] font-bold">✓</span> Like 2–3
                    Posts
                  </li>
                  <li className="flex gap-2">
              ...
              <div className="bg-[#fe5454]/10 p-6 rounded-xl border border-[#fe5454]/20">
                ...
                <ul className="space-y-2 text-slate-700">
                  <li className="flex gap-2">
                    <span className="text-[#fe5454] font-bold">✕</span> „Toller
                    Post!“ (Lazy Comments)
                  </li>
                  <li className="flex gap-2">
          ...
          <div className="glass-panel rounded-[2rem] p-8 sm:p-12 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <Infobox variant="amber">
                ...
                als Inspiration. Passe sie zwingend an deine Tonalität und deine
                Zielgruppe an. Authentizität funktioniert immer besser als
                &quot;Copy & Paste&quot;.
              </Infobox>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-white/40 p-4 rounded-xl border border-white/60">
                  ...
                  <ul className="space-y-1 text-sm text-slate-700">
                    ...
                    <li className="text-[#00D4AA]">✔ Einfach zu beantworten</li>
                ...
                <div className="bg-white/40 p-4 rounded-xl border border-white/60">
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-sm text-slate-700">
                    ...
                    <li>Pass dich ihrem Tonfall an (Matching & Mirroring).</li>
                  </ul>
                  <p className="text-xs text-slate-500 mt-2">
              ...
              <div className="border-t border-slate-200 pt-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h5 className="font-bold mb-2 text-slate-900">Signale:</h5>
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 items-start">
                        <span className="text-xl">🔴</span>
                        <p className="text-sm text-slate-700">
                          <span className="font-bold">Rote Flagge:</span> „Alles
                          gut“, „keine Prio“, „wir schauen nur“.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="border-t border-slate-200 pt-8">
                ...
                <div className="bg-[#9C88FF]/10 p-6 rounded-xl border border-[#9C88FF]/20">
                  ...
                  <ul className="list-disc pl-5 mb-4 text-sm text-slate-700">
                    <li>
                      Wiederhole ihre Herausforderung (&quot;Ich verstehe, X ist
                      das Problem...&quot;)
                    </li>
                    <li>
                  ...
                  <p className="italic text-slate-800">
                    „Basierend auf dem, was du gesagt hast, würde ich eine Sache
                    ändern: Starte mit Outreach → DANN schichte Content oben
                    drauf. Die meisten Kunden sehen so schnellere Erfolge, weil
                    sie früher echte Gespräche führen.“
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/40 p-5 rounded-xl border border-slate-200/60 shadow-sm">
                ...
                <p className="italic text-slate-700 text-sm">
                  ...
                  nicht zusammenarbeiten, nimmst du auf jeden Fall einen klaren
                  Fahrplan mit.“
                </p>
              </div>
              <div className="bg-white/40 p-5 rounded-xl border border-slate-200/60 shadow-sm">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                <div className="bg-slate-100 p-6 rounded-xl border border-slate-200 flex-1 w-full">
                  ...
                  <p className="text-slate-700 text-sm">
                    Sende Mehrwert (z.B. ein Link zu einem relevanten Post oder
                    Case Study). Keine Frage: &quot;Dachte, das könnte für dich
                    spannend sein.&quot;
                  </p>
                </div>
                <div className="bg-slate-100 p-6 rounded-xl border border-slate-200 flex-1 w-full">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mt-4 text-left">
              <div className="p-8 rounded-2xl border border-slate-200/60 bg-white/40 backdrop-blur-sm">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Du kennst jetzt die Theorie. Du wirst herausfinden, wie du die
                  Variablen testest, aber es wird Zeit kosten, deine Baseline zu
                  finden.
                </p>
              </div>
